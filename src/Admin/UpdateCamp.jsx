    ...
    <div className="max-w-4xl mx-auto p-6 rounded-lg shadow-md">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 md:grid-cols-2 gap-3">
        ...
        <div className="flex flex-col">
          ...
          <input {...register("campName", { required: "Camp Name is required" })} type="text" className="input-field" />
        ...
        <div className="flex flex-col">
          ...
          <input {...register("image", { required: "Image URL is required" })} type="text" className="input-field" />
        ...
        <div className="flex flex-col">
          ...
          <input {...register("dateTime", { required: "Date & Time is required" })} type="date" className="input-field" />
        ...
        <div className="flex flex-col">
          ...
          <input {...register("location", { required: "Location is required" })} type="text" className="input-field" />
        ...
        <div className="flex flex-col">
          ...
          <input {...register("healthcareName", { required: "Name is required" })} type="text" className="input-field" />
        ...
        <div className="flex flex-col">
          ...
          <input {...register("participantCount", { required: true, valueAsNumber: true })} type="number" className="input-field" />
        </div>

        {/* Fees */}
        <div className="flex flex-col">
          <label className="font-semibold">Fees</label>
          <input {...register("fees", { required: "Fees are required", valueAsNumber: true })} type="number" className="input-field" />
        ...
        <div className="col-span-1 md:col-span-2 flex flex-col">
          ...
          <textarea {...register("description", { required: "Description is required" })} rows="4" className="input-field"></textarea>
          {errors.description && <span className="text-red-500">{errors.description.message}</span>}
        </div>

        {/* Submit Button */}
        <div className="col-span-1 md:col-span-2 flex justify-center">
          <button type="submit" className="bg-blue-500 text-white px-6 py-2 rounded-md hover:bg-blue-600">Update Camp</button>
        </div>
      </form>
    </div>
  );
